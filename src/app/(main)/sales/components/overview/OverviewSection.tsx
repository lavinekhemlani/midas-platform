    ...
    <div className="@container flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 @2xl:grid-cols-2 @5xl:grid-cols-6 gap-4">
        ...
        <div className="h-full @5xl:col-span-2">
          <Card className="glass-luxury-card group h-full flex flex-col gap-0 border border-gray-200/10 hover:border-blue-500/20 transition-colors duration-300 min-h-[280px] relative overflow-hidden">
            {/* Subtle accent */}
              ...
              <div className="space-y-2.5 flex-1">
                {customers.slice(0, 5).map((customer, index) => {
                  ...
                  return (
                    <div
                      key={customer.id}
                      className="flex items-center gap-3 p-2 -mx-2 rounded-lg hover:bg-white/[0.02] transition-colors duration-150"
                    >
        ...
        <div className="h-full @5xl:col-span-2">
          <Card className="glass-luxury-card group h-full flex flex-col gap-0 border border-gray-200/10 hover:border-purple-500/20 transition-colors duration-300 min-h-[280px] relative overflow-hidden">
            {/* Subtle accent */}
        ...
        <div className="h-full @5xl:col-span-2">
          <Card className="glass-luxury-card group h-full flex flex-col gap-0 border border-gray-200/10 hover:border-amber-500/20 transition-colors duration-300 min-h-[280px] relative overflow-hidden">
            {/* Subtle accent */}
                      ...
                      <div className="space-y-1.5">
                        {topOverdueCustomers.map((customer, index) => (
                          <div
                            ...
                            className="flex items-center justify-between py-1 px-2 -mx-2 rounded hover:bg-white/[0.02] transition-colors"
                          >
      ...
      <div className="grid grid-cols-2 @2xl:grid-cols-4 gap-4">
        <Card className="glass-luxury-card group h-full border border-gray-200/10 hover:border-amber-500/20 p-4 transition-all duration-200 relative overflow-hidden">
        ...
        <Card className="glass-luxury-card group h-full border border-gray-200/10 hover:border-blue-500/20 p-4 transition-all duration-200 relative overflow-hidden">
        ...
        <Card className="glass-luxury-card group h-full border border-gray-200/10 hover:border-purple-500/20 p-4 transition-all duration-200 relative overflow-hidden">
        ...
        <Card className="glass-luxury-card group h-full border border-gray-200/10 hover:border-green-500/20 p-4 transition-all duration-200 relative overflow-hidden">
