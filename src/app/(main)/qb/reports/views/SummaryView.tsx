...
export function SummaryView() {
  ...
  const handleCustomStartDateChange = (newStart: string) => {
    ...
    setDateRange({ start: newStart, end: customEndDate })
    setPeriod('custom')
  }

  const handleCustomEndDateChange = (newEnd: string) => {
    setCustomEndDate(newEnd)
    setDateRange({ start: customStartDate, end: newEnd })
    setPeriod('custom')
  }
    ...
    <>
      ...
      <div className="@container space-y-16 max-w-[1800px] mx-auto">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 @3xl:grid-cols-2 @5xl:grid-cols-3 gap-x-12 gap-y-20">
        ...
        <div className="pt-10">
          ...
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-x-12 gap-y-20">
            <section
              className={cn(
        ...
        <div className="pt-10">
          ...
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-x-12 gap-y-20 mt-16">
            <section className={sectionHover}>
